...
<body>
  <?php
    $host = 'sql112.epizy.com';  // Хост, у нас все локально
    $user = 'epiz_24801086';    // Имя созданного вами пользователя
    $pass = '4B9pHdL5fCg0I'; // Установленный вами пароль пользователю
    $db_name = 'epiz_24801086_product';   // Имя базы данных
